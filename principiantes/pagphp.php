...
<nav class="navbar navbar-expand-lg navbar-light color-menu" style="position:sticky; top: 0; width: 100%; z-index: 9999; background-color: rgb(95, 7, 107);">
  ...
  <img class="w-100" src="img/phpbg.png" alt="" width="1310px">
  <div class="container">
    <div class="row">

      <div class="col-md-6"> <br>
        <h1>Hablemos de PHP...</h1>
        <p>PHP es un lenguaje de programación destinado a desarrollar aplicaciones para la web y crear páginas web, favoreciendo la conexión entre los servidores y la interfaz de usuario.

          El usuario puede usar PHP para programar en cualquier proyecto y comercializarlo sin problemas.
          Está en constante perfeccionamiento, gracias a una comunidad de desarrolladores proactiva y comprometida.</p>
        <p>En los videos siguientes te mostraremos como empezar con esta herramienta,que sera el complemento de HTML para poder empezar a desarrollar este gran proyecto.</p>
        <strong>
      ...
      <div class="col-md-6"> <br>
        <img class="w-100" src="img/php.png" style="width: 400px; height:300px">
      </div>
    </div>
